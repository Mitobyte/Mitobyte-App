              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-shrink-0">
                  {profile.avatar_url ? (
                    <img
                      ...
                      alt={profile.name || profile.display_name || 'User'}
                    ...
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary/30 to-primary/60 flex items-center justify-center text-3xl font-bold border-4 border-primary/20">
                      {(profile.name || profile.display_name || 'U').charAt(0).toUpperCase()}
                    </div>
                  )}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-2xl font-bold truncate">
                    {profile.name || profile.display_name || 'Member'}
                  </h2>
            ...
            <Card className="bg-gradient-to-r from-primary/10 to-primary/5 border-primary/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Create your own profile and connect with {profile.name || profile.display_name} and other members!
                </p>
